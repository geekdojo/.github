...
**→ [Get Rasputin](https://github.com/geekdojo/rasputin-releases)** — images,
quickstart, and every release in one place.

| Repo | What it is |
| --- | --- |
| [rasputin-releases](https://github.com/geekdojo/rasputin-releases) | Downloads: flashable images + quickstart |
...
[raise your hand](https://github.com/geekdojo/rasputin-releases/issues).
