...
of nodes (a Raspberry Pi, or any UEFI amd64 box) plus a dedicated firewall node, managed
...
Everything is AGPL-3.0. **Status: alpha** — commodity-hardware proof
phase, running on real hardware today; custom hardware comes later.
